...
public class RegistrationController extends SelectorComposer<Window> {
	...
	/**
	 * Handles registration form submission. Validates inputs, checks for existing
	 * user, and persists a new customer.
	 */
	...
	public void register() {
		...
		try {
			...
			if (!password.equals(confirmPassword)) {
				...
				Messagebox.show("Password and confirm password do not match.", "Warning", Messagebox.OK,
			...
			Messagebox.show("Something went wrong. Please try again later.", "Exception", Messagebox.OK,
					Messagebox.ERROR);
		}
	}
