...
/**
 * Controller responsible for handling login interactions within the CapitalBank
 * application. It validates the email and password provided by the user,
 * authenticates credentials, sets session attributes, and redirects users based
